...
int main()
{
	char *fileName0 = "../Datasets/Image/1.jpg";
	char *fileName1 = "../Datasets/Image/2.png";
	char *fileName2 = "../Datasets/Image/3.png";
	...
	int diffusionStep = 0;
	AddDiffusionParameters(diffusionStep, timeSteps, h0 * w0 * c0, noise0, image0, diffusionResult0, squareRootAlphasCumulativeProduct, squareRootMinusOneAlphasCumulativeProduct);
	AddDiffusionParameters(diffusionStep, timeSteps, h1 * w1 * c1, noise1, image1, diffusionResult1, squareRootAlphasCumulativeProduct, squareRootMinusOneAlphasCumulativeProduct);
	AddDiffusionParameters(diffusionStep, timeSteps, h2 * w2 * c2, noise2, image2, diffusionResult2, squareRootAlphasCumulativeProduct, squareRootMinusOneAlphasCumulativeProduct);
